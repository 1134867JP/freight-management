...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'capacity' => 'capacidade',
        'status' => 'status',
        'dropoff_address_id' => 'endereço de descarga',
        'client_ids' => 'clientes',

        // Empresa (Platform)
        'company_slug' => 'slug',
        'company_is_active' => 'status da empresa',
        'remove_logo' => 'remoção do logo',
        'admin_name' => 'nome do administrador',
        'admin_email' => 'e-mail do administrador',
        'admin_password' => 'senha do administrador',
        'admin_whatsapp_phone' => 'WhatsApp do administrador',

        // Instância WhatsApp
        'instance_label' => 'identificador',
        'instance_name' => 'nome da instância',
        'instance_base_url' => 'URL base',
        'instance_api_key' => 'API Key',
        'instance_is_active' => 'status da instância',
        'clear_instance_api_key' => 'remoção da API Key',
    ],
